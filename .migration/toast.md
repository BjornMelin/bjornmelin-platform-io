...
- Toasts marked `data-limited` by the provider are hidden, preserving the
  one-visible-toast contract when notifications overlap.
...
- Trigger overlapping notifications and confirm only the newest toast is visible.
